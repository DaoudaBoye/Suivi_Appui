...
<head>
    ...
    <title>Suivi demande appui</title>
    <!-- Favicon-->
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="pages/tables/Nouvelle_demande.php">Nouvelle demandes</a>
                            </li>
                           
                            <li>
                                <a href="pages/tables/Demande_en_attente_validation.php">Demandes en attente de validation</a>
                            </li>
                            <li>
                                <a href="pages/tables/DemandeValidee.php">Demandes Validées</a>
                            </li>
                            <li>
                                <a href="">Liste DEMANDES en attente</a>
                            </li>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                        <iframe  title="TestsuiviAppui" width="790" height="541.25" src="https://app.powerbi.com/reportEmbed?reportId=9dfb3093-caa9-4dfd-a33f-1f4e89e13362&autoAuth=true&ctid=b3e36c19-f28c-4d0d-b496-8827fe568a51" frameborder="0" allowFullScreen="true"></iframe>  
