...
<body>
  ...
  <div class="demo-page my-demo">
    ...
    <nav>
        <ul>
          <li>
            <a href="http://localhost:81/suiviAppui/app/views/adminConfirm.php">
          ...
          <li>
            <a href="http://localhost:81/suiviAppui/app/views/sfdRegister.php">
          ...
          <li>
            <a href="http://localhost:81/suiviAppui/app/views/listeSFD.php">
          ...
          <li>
            <a href="http://localhost:81/suiviAppui/app/views/validerForm.php">
    ...
    <main class="demo-page-content">
      ...
      <section>
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return validateForm()">
          ...
          <div class="btn-group">
              <a href="http://localhost:81/suiviAppui/app/views/direction/sfdRegister.php" class="btn btn-primary active" aria-current="page">SFD</a>
              <a href="http://localhost:81/suiviAppui/app/views/direction/structureRegister.php" class="btn btn-primary">Autre Structure</a>
          </div>
