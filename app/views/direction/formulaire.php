...
document.getElementById('type_appui').addEventListener('change', function() {
    ...
    var quantiteField = document.getElementsByName('Qt_equi_oct')[0];
    ...
    if (selectedOption === "Formation") {
        hideElement(quantiteField);
        hideElement(quantiteLabel);
    } else {
        showElement(quantiteField);
        showElement(quantiteLabel);
        hideElement(Theme);
