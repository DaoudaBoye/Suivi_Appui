      ...
      <section>
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return validateForm()">
          ...
          <div id="sfdField" class="nice-form-group">
            ...
            <input type="text" id="sfdInput" name="agrementSFD">
          </div>

          <div class="nice-form-group">
            <label>Nom SFD</label>
            <input type="text" placeholder="Name SFD" name="nameSFD" />
          </div>

          <div class="nice-form-group">
            <label>Sigle SFD</label>
            <input type="text" placeholder="Sigle SFD" name="sigleSFD"  />
          </div>

          <div class="nice-form-group">
            <label>Phonenumber</label>
            <input type="tel" placeholder="Contact SFD" value="" class="icon-right" name="contactSFD" id="contactSFD" />
            </div>
