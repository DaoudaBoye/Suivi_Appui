...
$sql_total = "SELECT COUNT(*) AS total_demandes FROM demande_appui WHERE Viser = 1 AND Valider = 1";
...
<body>
  ...
  <nav>
    ...
    <main class="demo-page-content col-12 centered-form">
      <section>
      <h1 class="card-title" style="text-align: center;">Liste des demandes validées</h1>
      <div class="row mb-3">
