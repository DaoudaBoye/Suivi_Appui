...
//    Méthode pour enregistrer un SFD
    public function enregistrerSFD($data) {
        try {
            ...
            $contactSFD = $data['contactSFD']; // Utilisez $data pour la cohérence
            $region = $data['region'];
            ...
            $query = "INSERT INTO liste_sfd (Agrement, Nom_SFD, SigleSFD, Contact, id_dept) 
            VALUES (?, ?, ?, ?, ?)";
            ...
            $stmt->bind_param("ssssi", $agrementSFD, $nomSFD, $sigleSFD, $contactSFD, $idDept);
